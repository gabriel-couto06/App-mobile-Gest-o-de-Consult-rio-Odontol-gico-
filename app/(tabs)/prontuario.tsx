...
function handleReset() {
  ...
  function salvarPaciente() {
    ...
    router.push("/(agenda)/novo?selecionarPaciente=1")
  }
    ...
    <TouchableOpacity style={{ marginLeft: 18 }} onPress={abrirConfig}>
     ...
     <View style={styles.container}>
      ...
      <Text style={{ backgroundColor: '#035087',
          ...
          width: 185, height: 8, marginBottom: 18 }}></Text>
              ...
              onPress={() =>
                Alert.alert(
                  ...
                  [
                    ...
                    { text: 'Excluir', onPress: () => removerPaciente(item.id) },
                  ]
                )
              }
            >
            ...
            <ScrollView>
              ...
              <View style={{ flexDirection: 'row', gap: 10, marginBottom: 8 }}>
                ...
                <TouchableOpacity
                  ...
                  onPress={() =>
                    setForm((p) => ({ ...p, convenio: 'nao', nomeConvenio: '' }))
                  }
                >
...
/>
            ...
            <TouchableOpacity style={styles.btnSalvar} onPress={salvarPaciente}>
